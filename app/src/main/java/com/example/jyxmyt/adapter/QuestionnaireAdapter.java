...
public class QuestionnaireAdapter extends BaseAdapter {
    ...
    public QuestionnaireAdapter(Context context, List<Questionnaire> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final QuestionnaireAdapter.ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.evaluation_heart_list_item, null);
            holder = new QuestionnaireAdapter.ViewHolder();
            ...
            holder = (QuestionnaireAdapter.ViewHolder) convertView.getTag();
        }

        final Questionnaire schedule = list.get(position);
        ...
        holder.radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                ...
                Questionnaire schedule = list.get(index);
    ...
    @Deprecated
    private void change(QuestionnaireAdapter.ViewHolder holder, Psychometrics schedule) {
